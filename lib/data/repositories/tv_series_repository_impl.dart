...
class TvSeriesRepositoryImpl implements TvSeriesRepository {
  ...
  @override
  Future<Either<Failure, TvSeriesDetails>> getTvSeriesDetail(int id) async {
    try {
      final result = await remoteDataSource.getTvSeriesDetails(id);
  ...
  @override
  Future<Either<Failure, String>> saveWatchlist(TvSeriesDetails tvSeries) async {
    try {
      final result =
  ...
  @override
  Future<Either<Failure, String>> removeWatchlist(TvSeriesDetails tvSeries) async {
    try {
      final result =
