...
import 'package:data/models/tv_series_network_model.dart';
import 'package:data/models/tv_series_season_model.dart';
...
void main() {
  ...
  group('Get TV Series Detail', () {
    final tId = 1;
    final tTvResponse = TvSeriesDetailsModel(
        adult: false,
    ...
    test(
        ...
        () async {
      // arrange
      when(mockRemoteDataSource.getTvSeriesDetails(tId))
          .thenAnswer((_) async => tTvResponse);
      // act
      final result = await repository.getTvSeriesDetail(tId);
      // assert
      verify(mockRemoteDataSource.getTvSeriesDetails(tId));
